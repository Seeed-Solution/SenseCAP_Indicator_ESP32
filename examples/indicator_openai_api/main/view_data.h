...
struct view_data_openai_request_st
{
    int progress;
    char state[32];
};
...
enum {
    ...
    VIEW_EVENT_CHATGPT_REQUEST, //struct view_data_openai_request
    VIEW_EVENT_CHATGPT_RESPONSE, // struct view_data_openai_response
        
    VIEW_EVENT_OPENAI_REQUEST_ST, // struct view_data_openai_request_st

    VIEW_EVENT_OPENAI_API_KEY_READ,
    VIEW_EVENT_OPENAI_API_URL_READ,
    VIEW_EVENT_OPENAI_MODEL_NAME_READ,
    VIEW_EVENT_OPENAI_SYSTEM_PROMPT_READ,
    VIEW_EVENT_ALL,
};
