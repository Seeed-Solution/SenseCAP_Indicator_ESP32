...
lv_obj_t *ui_temperature_switch;
lv_obj_t *ui_temperature_slider;
lv_obj_t *ui_temperature_value;

lv_obj_t *ui_max_tokens_label;
lv_obj_t *ui_max_tokens_switch;
lv_obj_t *ui_max_tokens_slider;
lv_obj_t *ui_max_tokens_value;

lv_obj_t *ui_api_key_status_panel;
lv_obj_t *ui_api_key_status_label;
lv_obj_t *ui_api_url_status_panel;
lv_obj_t *ui_api_url_status_label;
lv_obj_t *ui_model_name_status_panel;
lv_obj_t *ui_model_name_status_label;
