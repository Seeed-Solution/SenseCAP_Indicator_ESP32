...
extern lv_obj_t *ui_temperature_switch;
extern lv_obj_t *ui_temperature_slider;
extern lv_obj_t *ui_temperature_value;
// 添加Max tokens相关UI元素
extern lv_obj_t *ui_max_tokens_label;
extern lv_obj_t *ui_max_tokens_switch;
extern lv_obj_t *ui_max_tokens_slider;
extern lv_obj_t *ui_max_tokens_value;
// 添加API状态相关UI元素
extern lv_obj_t *ui_api_key_status_panel;
extern lv_obj_t *ui_api_key_status_label;
extern lv_obj_t *ui_api_url_status_panel;
extern lv_obj_t *ui_api_url_status_label;
extern lv_obj_t *ui_model_name_status_panel;
extern lv_obj_t *ui_model_name_status_label;
// 添加事件回调函数声明
