 ...
 * Size: 25 px
 * Bpp: 8
 * Opts: --bpp 8 --size 25 --font D:\Indicator_LoRaWAN\LoRaWANspj\assets\fonts\LibraSans-Bold.ttf -o D:\Indicator_LoRaWAN\LoRaWANspj\assets\fonts\ui_font_HeadTitle.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
