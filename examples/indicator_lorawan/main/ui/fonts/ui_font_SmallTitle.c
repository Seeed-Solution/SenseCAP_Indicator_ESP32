 ...
 * Size: 20 px
 * Bpp: 8
 * Opts: --bpp 8 --size 20 --font D:\Indicator_LoRaWAN\LoRaWANspj\assets\fonts\LibraSans-Bold.ttf -o D:\Indicator_LoRaWAN\LoRaWANspj\assets\fonts\ui_font_SmallTitle.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_SMALLTITLE
#define UI_FONT_SMALLTITLE 1
#endif

#if UI_FONT_SMALLTITLE
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_SmallTitle = {
#else
lv_font_t ui_font_SmallTitle = {
#endif
