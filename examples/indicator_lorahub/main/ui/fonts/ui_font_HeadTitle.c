 ...
 * Size: 25 px
 * Bpp: 8
 * Opts: --bpp 8 --size 25 --font D:\indicator_lorahub\LoRaWANspj\assets\fonts\LibraSans-Bold.ttf -o D:\indicator_lorahub\LoRaWANspj\assets\fonts\ui_font_HeadTitle.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_HEADTITLE
#define UI_FONT_HEADTITLE 1
#endif

#if UI_FONT_HEADTITLE
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_HeadTitle = {
#else
lv_font_t ui_font_HeadTitle = {
#endif
