 ...
 * Size: 20 px
 * Bpp: 8
 * Opts: --bpp 8 --size 20 --font D:\indicator_lorahub\LoRaWANspj\assets\fonts\LibraSans-Bold.ttf -o D:\indicator_lorahub\LoRaWANspj\assets\fonts\ui_font_SmallTitle.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
