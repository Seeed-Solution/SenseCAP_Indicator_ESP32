...
static struct terminal_wifi _g_wifi_model;
...
// bool terminal_wifi_is_connect(char *p_ssid, int *p_rssi)
// {
//     return true; //todo
// }
...
// net check
static void __terminal_wifi_task(void *p_arg)
{
    int cnt = 0;
    struct view_data_wifi_st st;
...
int terminal_wifi_init(void)
{
    ...
    xTaskCreate(&__terminal_wifi_task, "__terminal_wifi_task", 1024 * 5, NULL, 10, NULL);
