...
struct terminal_sensor_present_data
{
...
struct terminal_sensor_history_data
{
...
static struct terminal_sensor_history_data  __g_sensor_history_data;
static struct terminal_sensor_present_data  __g_sensor_present_data;
...
static void __sensor_history_data_save(void)
{
    xSemaphoreTake(__g_data_mutex, portMAX_DELAY);
    esp_err_t ret = 0;
    ret = terminal_storage_write(SENSOR_HISTORY_DATA_STORAGE, (void *)&__g_sensor_history_data, sizeof(struct terminal_sensor_history_data));
    xSemaphoreGive(__g_data_mutex);
...
static void __sensor_history_data_restore(void)
{
    ...
    ret = terminal_storage_read(SENSOR_HISTORY_DATA_STORAGE, (void *)&__g_sensor_history_data, &len);
